...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return ChordNodeProto.internal_static_chord_NotifyRequest_descriptor;
  }

  @Override
  protected FieldAccessorTable
      internalGetFieldAccessorTable() {
    return ChordNodeProto.internal_static_chord_NotifyRequest_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            NotifyRequest.class, Builder.class);
  }
  ...
  public static NotifyRequest parseFrom(
  ...
  public static NotifyRequest parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static NotifyRequest parseFrom(
  ...
  public static NotifyRequest parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static NotifyRequest parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }
  public static NotifyRequest parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(NotifyRequest prototype) {
  ...
  public static final class Builder extends
    ...
    public NotifyRequest build() {
      NotifyRequest result = buildPartial();
    ...
    @Override
    public NotifyRequest buildPartial() {
      NotifyRequest result = new NotifyRequest(this);
      if (identifierBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof NotifyRequest) {
        return mergeFrom((NotifyRequest)other);
      } else {
    ...
    public Builder mergeFrom(NotifyRequest other) {
      if (other == NotifyRequest.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      NotifyRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (NotifyRequest) e.getUnfinishedMessage();
